#!/usr/bin/env python3
"""
Build and refresh the Alibaba GitHub repository catalog.

The script fetches public GitHub metadata for repositories in Alibaba's
alibaba organization that were updated in the last three months and have more
...
USER_AGENT = "alibaba-repos-catalog"
AUTO_KEYWORD_TERMS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("Analytics", ("analytics", "data processing", "graph computing")),
    ("Cloud", ("cloud", "kubernetes", "container")),
    ("Microservices", ("microservice", "service discovery", "middleware")),
    ("Java", ("java", "jvm", "spring")),
    ("Web", ("web", "react", "typescript")),
    ("Mobile", ("mobile", "flutter", "android")),
    ("Networking", ("network", "quic", "http/3")),
    ("Observability", ("observability", "monitoring", "diagnostic")),
    ("Security", ("security", "vulnerability", "fuzzing")),
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        ...
        "Agent frameworks, language models, reinforcement learning, inference engines, vector search, and AI applications.",
        "blue",
        (
            "agent",
    ...
    Cluster(
        ...
        "Data, Databases & Analytics",
        "Databases, replication, caching, data integration, graph computing, analytics, and storage engines.",
        "purple",
        (
            "analytics",
            "cache",
    ...
    Cluster(
        "cloud-microservices-middleware",
        "Cloud, Microservices & Middleware",
        "Service discovery, configuration, cloud-native frameworks, resilience, orchestration, and distributed middleware.",
        "cyan",
        (
            "cloud",
            "configuration",
    ...
    Cluster(
        ...
        "Languages, Libraries & Developer Tools",
        "Java and C++ libraries, code quality, diagnostics, serialization, testing, and general developer tooling.",
        "green",
        (
            "c++",
            "code",
    ...
    Cluster(
        ...
        "React, TypeScript, frontend tooling, mobile integration, visualization, forms, and interface automation.",
        "yellow",
        (
            "android",
            "canvas",
    ...
    Cluster(
        ...
        "Systems, Networking & Observability",
        "Web servers, protocols, operating systems, performance, telemetry, diagnostics, and infrastructure monitoring.",
        "red",
        (
            "collector",
            "diagnostic",
    ...
    Cluster(
        "research-vision-media",
        "Research, Vision & Media",
        "Computer vision, video and audio generation, 3D, datasets, benchmarks, and applied research projects.",
        "orange",
        (
            "3d",
            "audio",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update Alibaba GitHub repository catalog.")
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        ...
        "page-agent": "ai-agents-ml",
        "pipcook": "ai-agents-ml",
        "recis": "ai-agents-ml",
        "rock": "ai-agents-ml",
        "roll": "ai-agents-ml",
        "rtp-llm": "ai-agents-ml",
        "skill-up": "ai-agents-ml",
        "spring-ai-alibaba": "ai-agents-ml",
        "tair-kvcache": "ai-agents-ml",
        "torcheasyrec": "ai-agents-ml",
        "unifiedmodel": "ai-agents-ml",
        "zvec": "ai-agents-ml",
        "alisql": "data-databases-analytics",
        "canal": "data-databases-analytics",
        "datax": "data-databases-analytics",
        "druid": "data-databases-analytics",
        "fastjson2": "languages-libraries-tools",
        "graphscope": "data-databases-analytics",
        "jetcache": "data-databases-analytics",
        "mongoshake": "data-databases-analytics",
        "nacos": "cloud-microservices-middleware",
        "sentinel": "cloud-microservices-middleware",
        ...
        "canvas-ui": "web-mobile-ui",
        "cloud-charts": "web-mobile-ui",
        "flutter_boost": "web-mobile-ui",
        "hooks": "web-mobile-ui",
        "kiwi": "web-mobile-ui",
        "react-intl-universal": "web-mobile-ui",
        "x-render": "web-mobile-ui",
...
<title>Alibaba GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  body {{
    ...
    min-height: 100vh;
    background:
      radial-gradient(circle at 85% -10%, rgba(8, 102, 255, 0.2), transparent 28rem),
  ...
  .logo-box {{
    ...
    place-items: center;
    border-radius: 8px;
    background: linear-gradient(135deg, #0866ff, #8b5cf6);
    color: #ffffff;
    font-weight: 800;
    box-shadow: 0 0 24px rgba(8, 102, 255, 0.28);
  }}
  ...
  .search-panel {{
    ...
    border-radius: 12px;
    background:
      radial-gradient(circle at top right, rgba(8, 102, 255, 0.14), transparent 24rem),
  ...
  .search-input:focus {{
    border-color: rgba(8, 102, 255, 0.82);
  ...
  tbody tr:hover {{ background: rgba(8, 102, 255, 0.045); }}
  ...
  .activity-bar span {{
    ...
    background: linear-gradient(90deg, #ff6a00, #ff9a3d, #6f7bf7);
  }}
  ...
  .footer a {{ color: var(--alibaba); text-decoration: none; }}
...
<body>
  <header class="header page-header">
    <h1 class="page-title"><span class="logo-box">A</span>Alibaba GitHub Repository Atlas</h1>
    <p>Searchable snapshot of public repositories from Alibaba's <a href="https://github.com/orgs/alibaba/repositories" target="_blank" rel="noreferrer">alibaba organization</a>. Included repositories have more than 200 stars and were pushed within the last three months, since {cutoff}.</p>
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://www.alibabacloud.com/opensource" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">Alibaba Open Source</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://damo.alibaba.com/" target="_blank" rel="noreferrer" style="display: inline;">Alibaba DAMO Academy</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://www.alibabacloud.com/developer" target="_blank" rel="noreferrer" style="display: inline;">Alibaba Cloud Developers</a>
    </p>
...
def main() -> int:
    ...
    print(f"Wrote {args.file} with {len(repos)} Alibaba repositories")
