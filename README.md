...
`alibaba-repos` is a static catalog of active repositories from Alibaba's
`alibaba` GitHub organization. It groups public repositories by purpose and
...
while each research cluster shows every qualifying repository sorted by stars.

The seven clusters cover AI and agents, data and databases, cloud and
middleware, developer tooling, web and mobile interfaces, systems and
observability, and applied research.
...
- `favicon.svg` - Alibaba-themed favicon.
...
- `cloudflare/worker.js` - proxies the site at `https://glaubi.net/alibaba`.
